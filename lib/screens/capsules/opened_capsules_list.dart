...
class OpenedCapsulesList extends StatelessWidget {
  @override
    ...
    return Observer(
      builder: (_) {
        ...
        List<Capsule> capsules =
            mainStore.friendCapsulesOpenedStore.friendCapsulesOpened;
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Theme(
                  ...
                  child: CapsuleWidget(capsule: capsules[index], color: Color(0xFFF9E4A4),)),
            );
          },
        );
      },
